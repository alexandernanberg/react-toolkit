...
function concat(...args) {
  const values = Array.from(args).filter(e => e != null)
  const baseArray = Array.isArray(values[0]) ? values[0] : [values[0]]
  return Array.prototype.concat.apply(baseArray, values.slice(1))
}
